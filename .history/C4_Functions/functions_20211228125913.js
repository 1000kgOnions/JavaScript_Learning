...
let callFunc = anotherFunction(); // otherMessage is no longer accessible (khi fn này chạy xong thì các biến trong fn ko truy xuất dc nữa)
callFunc(); // hello (nhưng với closure thì vẫn truy xuất dc để)
