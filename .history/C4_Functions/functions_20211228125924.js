...
let callFunc = anotherFunction(); // otherMessage is no longer accessible (khi fn này chạy xong thì các biến trong fn ko truy xuất dc nữa nhưng với closure thì vẫn truy xuất dc)
callFunc(); // hello ()
