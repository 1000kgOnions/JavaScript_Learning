...
let callFunc = anotherFunction(); // otherMessage is no longer accessible ( bth khi fn này chạy xong thì các biến trong fn ko truy xuất dc nữa nhưng với closure thì vẫn truy xuất dc để fn sayHi có thể lấy dc biến otherMess)
callFunc(); //
